...
OUTPUT_DIR = r'/storage/md_keren/shitay/outputs/variance_filtered/'
...
if __name__ == '__main__':
    ...
    for variance in VARIANCE:
        ...
        # pickle.dump((cells_embedded), open(join(OUTPUT_DIR, f'immune_TSNE_embedded_var{variance}.pkl'), 'wb'))
