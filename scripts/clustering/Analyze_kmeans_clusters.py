...
OUTPUT_PATH = r'/storage/md_keren/shitay/outputs/cluster_analysis/cluster_analysis_21.3.21'
FILTERED_CELLS_PATH = fr'/storage/md_keren/shitay/outputs/variance_filtered/immune_cells_var0.315.pkl'
KMEANS_PATH = r'/storage/md_keren/shitay/outputs/kmeans/row_kmeans/'
