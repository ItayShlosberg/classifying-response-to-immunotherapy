...
OUTPUT_PATH = r'/storage/md_keren/shitay/outputs/clustering/myeloid/cluster_analysis/cluster_analysis_11.8.21' # cytotoxic_t_cells/myeloid

KMEANS_ROW_CLUSTERS_PATH = r'/storage/md_keren/shitay/outputs/clustering/myeloid/kmeans/cohort_26.6.21_run_11.8.21/row_kmeans'
