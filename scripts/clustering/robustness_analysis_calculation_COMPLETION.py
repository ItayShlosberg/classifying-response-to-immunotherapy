...
COMPLETION_LIST = [(2, 33), (2, 87), (3, 8), (3, 76), (4, 36), (4, 65), (4, 83), (6, 22), (6, 29), (6, 78), (8, 22), (8, 54), (8, 79), (9, 21), (9, 92), (11, 29), (11, 62), (15, 36)]

if __name__ == '__main__':


    # job id, between 0-1499
    job_process = int(sys.argv[1])


    k = COMPLETION_LIST[job_process][0]
    run = COMPLETION_LIST[job_process][1]
