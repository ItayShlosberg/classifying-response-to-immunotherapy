"""
After running Analyze_kmeans_clusters.py you have the marker gene list.
...
OUTPUT_PATH = r'/storage/md_keren/shitay/outputs/clustering/immune/markers/subcohort_1.1.22_run_1.1.22_logFC_0.5'
CLUSTERING_ANALYSIS_PATH = r'/storage/md_keren/shitay/outputs/clustering/immune/cluster_analysis/subcohort_1.1.22_run_1.1.22_logFC_0.5' # cytotoxic_t_cells/myeloid
