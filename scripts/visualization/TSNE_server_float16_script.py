...
OUTPUT_PATH = r'/storage/md_keren/shitay/outputs/TSNE/immune_TSNE_embedded_var0.315_float16.pkl'
COHORT_PATH = r'/storage/md_keren/shitay/Data/droplet_seq/cohort/cohort_float16.pkl'
...
if __name__ == '__main__':
    ...
    print(f"Using variance {variance}")
