"""
Not in use as is. Only for analysis.
That script helped to explore smart-seq data at the first time.
We used it to cluster, and visualize the data.
"""
...
def draw_heatmap(dataset):
    """
    Draw a expression heatmap based on list of genes
    :param dataset: cells
    """
    path = r'DATA\high expressed genes list.txt'
