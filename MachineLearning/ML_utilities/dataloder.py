...
class Droplet_data_manager:
    ...
    """
    def __init__(self, dataset, CLINICAL_LABELS_PATH = r'C:\Users\KerenYlab\Desktop\Technion studies\Keren laboratory\Data\tables\clinical_labels.xlsx',
        ...
        self.no_used_samples = self.clinical_table[self.clinical_table['response'] == 'not in use for now'].index.tolist()
    ...
    def filter(self, filter_by_cell_type, filter_by_immune_cell_type, supervised_classification, is_data_prior_to_therapy):
        """
        ...
        if filter_by_immune_cell_type:
            ...
            indices = [filter_by_immune_cell_type in l for l in self.dataset.cells_information.getattr('cell_type_list')]
